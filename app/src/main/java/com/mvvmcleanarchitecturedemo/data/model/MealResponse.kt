package com.mvvmcleanarchitecturedemo.data.model

import com.mvvmcleanarchitecturedemo.domain.model.MealDetailsResponse
import com.mvvmcleanarchitecturedemo.domain.model.SearchMealResponse
...
fun Meal.toDomainMeal() : SearchMealResponse {
    return SearchMealResponse(
        id= this.idMeal,
        name = this.strMeal ?: "",
...
fun Meal.toDomainDetailsMeal() : MealDetailsResponse {
